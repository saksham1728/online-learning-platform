...
function EngineeringDashboard() {
  ...
  const quickActions = [
    ...
    {
      title: 'Mock Exams',
      description: 'Take realistic mock exams',
      icon: TestTube,
      href: '/workspace/engineering-portal/mock-exams',
      color: 'bg-red-500'
    },
    {
      title: 'Practice Mode',
    ...
    },
    {
      ...
      icon: BookOpen,
      href: '/workspace/engineering-portal/question-papers',
      color: 'bg-purple-500'
    },
    {
      title: 'Coding IDE',
      ...
      icon: Code,
      href: '/workspace/engineering-portal/coding-ide',
      color: 'bg-indigo-500'
    },
    {
      title: 'Subjects',
      ...
      icon: BookOpen,
      href: '/workspace/engineering-portal/subjects',
      color: 'bg-orange-500'
    }
  ]
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center space-y-4">
          ...
          <Link href="/workspace/engineering-portal/branch-selection">
  ...
  return (
    <div className="space-y-8">
      ...
      <Card>
        <CardHeader>
          <CardTitle>Engineering Portal Features</CardTitle>
        </CardHeader>
        <CardContent>
          ...
          <CardContent>
            <div className="space-y-3">
              {subjects.filter(s => s.semester === primaryBranch.semester).slice(0, 6).map((subject, index) => (
                <Link key={index} href={`/workspace/engineering-portal/subjects/${subject.subjectCode}`}>
